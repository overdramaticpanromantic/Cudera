...
public class HeatedBlendingPipe extends ArmoredConduit {
    ...
    public HeatedBlendingPipe(String name) {
        super(name);
    }
    ...
    public class HeatedBlendingPipeBuild extends ArmoredConduitBuild implements HeatedBlock {
        @Override
        public void draw() {
            super.draw();
        ...
        public boolean acceptLiquid(Building source, Liquid liquid) {
            return ((this.block.hasPower && consPower.efficiency(this) > 0f && super.acceptLiquid(source, liquid) && (tile == null || source.block instanceof Conduit || source.block instanceof DirectionLiquidBridge || source.block instanceof LiquidJunction || source.tile.absoluteRelativeTo(tile.x, tile.y) == rotation || !source.proximity.contains(this))));
        }
